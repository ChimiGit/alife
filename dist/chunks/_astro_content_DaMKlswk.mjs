import { o as objectType, h as dateType, n as numberType, i as arrayType, s as stringType, A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, j as escape, k as renderUniqueStylesheet, l as renderScriptElement, p as createHeadAndContent, d as renderComponent } from './astro/server_CyXtAmDb.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BbqCr4QJ.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_BASE_PATH": "/alife", "PUBLIC_SITE_URL": "https://chimigit.github.io", "SITE": "https://alife.institute", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CaKcka7-.mjs').then(n => n._);
...
export { DEFAULT_OUTPUT_FORMAT as D, VALID_SUPPORTED_FORMATS as V, DEFAULT_HASH_PROPS as a, getCollection as g, isRemotePath as i, joinPaths as j };
